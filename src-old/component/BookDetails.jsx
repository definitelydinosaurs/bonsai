...
const BookDetails = ({ authors = [], ...props }) => (
  <View className='flex-1 w-full items-center'>
    ...
    { props.publishDate && <Text className='text-center'>Published: { props.publishDate }</Text> }
    { props.numberOfPages && <Text className='text-center'>Pages: { props.numberOfPages }</Text> }
  </View>
)
